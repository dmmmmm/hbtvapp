...
public class SU {
	 ...
	 * 省略号
	 */
	public final static char ELLIPSIZE = '…';
	/** 数字 */
	public final static String ACCOUNT_NUMBER = "[0-9]";
	/** 字母 */
	public final static String ACCOUNT_LETTER = "[A-Za-z]";
	/** 字母开头 ,6-20位 */
	public final static String REGISTER_ACCOUNT = "^[A-Za-z]{1}[\\dA-Za-z]{5,19}$";
	/** 手机号 */
	public final static String PHONE_PATTERN = "^[1][3-8]\\d{9}$";
	public final static String NUMBER_PATTERN = "^[0-9]\\d{10}$";
	/** 电子邮件格式 */
	public final static String EMAIL_PATTERN = "^([a-zA-Z0-9_-])+@([a-zA-Z0-9_-])+((\\.[a-zA-Z0-9_-]{2,3}){1,2})$";
	/** 日期格式 */
